...
| Time | Segment |
|---|---|
| 0:00–15:00 | Slides 1–18 (live demo beats 1–4 inside slide 14) |
| 15:00–15:05 | Demo beat 5: mock eval gate, live in the terminal (the closer) |
| 15:05–25:00 | Committee Q&A — Agent view left running behind you |
...
commanded across a threshold (beat 1), a model showing restraint with
the buzzer budget standing behind it (beat 2), a room kept safe with
the model dead
